...
var getColor = (theme, color, fallback) => {
  const hex = (0, import_utils.memoizedGet)(theme, `colors.${color}`, color);
...
function randomColor(opts) {
  ...
  if (!opts || (0, import_utils.isEmptyObject)(opts)) {
    return fallback;
  }
...
function toRef(operand) {
  if ((0, import_utils3.isObject)(operand) && operand.reference) {
