...
export default function Form() {
  return (
    <div className="flex-col ">
      <h1 className="flex items-center justify-center min-h-full pt-40 pb-10 text-4xl font-extrabold leading-none tracking-tight text-transparent sm:px-6 lg:px-8 md:text-5xl lg:text-6xl animate-pulse sm:text-4xl bg-clip-text bg-gradient-to-r from-primary-400 to-primary-600">
        Mint
      </h1>
