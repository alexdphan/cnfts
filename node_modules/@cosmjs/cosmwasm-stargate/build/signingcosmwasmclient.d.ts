...
export declare class SigningCosmWasmClient extends CosmWasmClient {
    ...
    // example of SigningCosmWasmClient constructor would be 
    // `new SigningCosmWasmClient(tmClient, signer, options)`
    /**
     ...
     * e.g SigningCosmWasmClient would be something like  `new SigningCosmWasmClient(undefined, signer, options)`
     */
