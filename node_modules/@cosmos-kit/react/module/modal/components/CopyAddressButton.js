...
export const CopyAddressButton = ({
  ...
  return /*#__PURE__*/React.createElement(Button, {
    ...
    onClick: onCopy
  }, address && walletIcon && /*#__PURE__*/React.createElement(Box, {
    borderRadius: "full",
    w: "full",
    h: "full",
    ...
    letterSpacing: "0.4px",
    opacity: 0.75
  }, displayAddress), address && /*#__PURE__*/React.createElement(Icon, {
    as: hasCopied ? FaCheckCircle : FiCopy,
    w: SIZES[size].icon,
    h: SIZES[size].icon,
    ml: 2,
    opacity: 0.9,
    color: hasCopied ? 'green.400' : handleChangeColorModeValue(colorMode, 'gray.500', 'whiteAlpha.400')
  }));
};