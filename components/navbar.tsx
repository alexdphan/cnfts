...
export default function Navbar() {
  ...
  return (
    <Disclosure
      as="nav"
      className="text-black bg-clight dark:bg-black dark:text-white"
      // shadow in classname
    >
      {({ open }) => (
        <>
            ...
            <div className="flex justify-between h-16">
              ...
              <div className="flex items-center">
                ...
                <div className="hidden md:ml-4 md:flex md:flex-shrink-0 md:items-center">
                  ...
                  <button
                    // className="inline-flex items-center justify-center w-12 h-10 text-black border rounded-lg dark:text-white hover:bg-black/10 dark:hover:bg-white/10 border-black/10 dark:border-white/10"
